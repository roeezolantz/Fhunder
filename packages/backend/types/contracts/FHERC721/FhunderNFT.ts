...
export interface FhunderNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_tokenIdCounter"
      | "approve"
...
export interface FhunderNFT extends BaseContract {
  connect(runner?: ContractRunner | null): FhunderNFT;
  waitForDeployment(): Promise<this>;

  interface: FhunderNFTInterface;
  ...
  nftData: TypedContractMethod<
    [arg0: BigNumberish],
    [[bigint, bigint] & { encryptedAmount: bigint; campaignId: bigint }],
    "view"
  >;
